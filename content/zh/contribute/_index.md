...
2) [风格指南](#style-guide)
3) [处理现有Issue](#work-on-an-existing-issue)
...
开源办公室术语表存储在这个 [GitHub 仓库](https://github.com/todogroup/glossary)中。您可以在这里找到[Issue](https://github.com/todogroup/glossary/issues)和PR([PRs](https://github.com/todogroup/glossary/pulls))的列表。
...
## 处理已有Issue {#work-on-an-existing-issue}

在[术语表的GitHub仓库Issue](https://github.com/todogroup/glossary/issues)中找到待处理的Issue。
你可以使用标签（例如，英文语言、需要帮助、适合入门）来过滤Issue。

**注意**：您可以在维护者将Issue分配给你之后开始工作。
您一次只能认领一个术语。
...
无论如何，您都将从[创建Issue](#creating-an-issue)开始。
